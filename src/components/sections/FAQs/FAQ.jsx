  ...
  return (
    <motion.li variants={itemVariants} className="shrink-0 grow-0">
      ...
      >
        ...
        <p className="text-primary-50 mr-auto pr-4 text-left text-xl/loose font-medium tracking-tight max-xl:text-lg/12 max-lg:text-lg/8 max-lg:font-semibold max-sm:text-base/6 max-sm:font-medium">
          {question.question}
        </p>
