...
const Features = () => {
  return (
    <section className="bg-primary-1500 overflow-hidden bg-[url('../src/assets/Noise.webp')] bg-repeat">
      <div className="text-primary-50 relative m-auto max-w-[90rem] px-24 py-24">
        <div className="bg-primary-1300 absolute top-[50%] left-[100%] h-[62.5rem] w-[62.5rem] -translate-[50%] rounded-full opacity-100 blur-[25rem]" />
        ...
        <div className="mb-20 grid grid-cols-2 items-center gap-x-16">
          ...
          <div className="z-1 max-w-lg justify-self-end">
            ...
            <p className="text-primary-100 font-ligh z-1 text-xl/loose">
