...
const Testimonials = () => {
  ...
  return (
    <section className="bg-gradient-to-top">
      <div className="m-auto flex max-w-[90rem] flex-col items-center px-24 py-26 max-xl:px-16 max-xl:py-18">
        <div className="mb-20 flex max-w-[51.625rem] flex-col items-center gap-y-4">
          ...
          <p className="text-primary-100 px-28 text-center text-xl/loose font-light max-xl:text-lg/8">
            {" "}
