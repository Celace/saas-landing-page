...
const Testimonials = () => {
  ...
  return (
    <section className="bg-gradient-to-top">
      <div className="m-auto flex max-w-[90rem] flex-col items-center px-24 py-26 max-xl:px-16 max-xl:py-18 max-lg:px-8 max-md:px-6">
        <div className="mb-20 flex max-w-[51.625rem] flex-col items-center gap-y-4 max-lg:mb-18 max-lg:gap-y-0">
          ...
          <p className="text-primary-100 px-28 text-center text-xl/loose font-light max-xl:text-lg/8 max-lg:text-lg/8 max-md:px-4">
            {" "}
